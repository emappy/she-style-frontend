...
function Footer() {
  return (
    <footer className="bg-black text-white px-8 py-12 mt-auto">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        {/* BRAND */}
        <div>
          <h2 className="text-2xl font-bold text-pink-300 mb-4">She Style</h2>
          <p className="text-gray-400 leading-relaxed">
            Premium women's fashion crafted for comfort, elegance, and
            confidence.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-400">
            ...
            <li>
              <Link to="/products" className="hover:text-pink-300 transition">
                Products
              </Link>
            </li>
            <li>
              <Link to="/cart" className="hover:text-pink-300 transition">
                Cart
              </Link>
            </li>
            <li>
      ...
      <div className="border-t border-gray-800 mt-10 pt-6 text-center text-gray-500 text-sm">
        © {new Date().getFullYear()} She Style. All rights reserved.
      </div>
    </footer>
  );
}
